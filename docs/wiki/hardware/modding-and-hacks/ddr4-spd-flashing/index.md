...
Гарантированно умеет анлокать hunix, но вроде как проблемы с samsung.

## Software

Скачиваешь [spd-programmer/DDRSPD.zip](@storageBaseUrl@/spd-programmer/DDRSPD.zip) и действуешь по инструкции. Там же достаточно много мануалов.
