...
Пришло время на практике раздербанить дамп на кусочки. Повсеместно будет использован самописный комбайн [uefi-mod-tools](/docs/wiki/hardware/tools/uefi-mod-tools/index.mdx). Все операции производятся в linux.
