...
Полный мануал что и как можно [посмотреть тут](../../../modding-and-hacks/megarac-sp/java-console/index.md), отличие только в том что П1 не нужно делать. Проверено на связке с [BMC 2.02.76714](#axiomtek-ami-megarac-sp-20276714)
