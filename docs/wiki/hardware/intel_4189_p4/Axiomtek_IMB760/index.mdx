...
> ДАЦН dpc627 не прошёл проверку фкэкср, основная закупка была произведена в третьем квартале 2023 года, в результате проверки были выявлены многоуровневые бэкдоры, вероятность последующего выхода из строя и блокировка оборудования критическая
>
> \- из одного из чатов
> 
> \* фкэкср - думаю речь о ФСТЭК
